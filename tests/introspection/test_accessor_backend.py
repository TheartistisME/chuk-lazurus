"""Smoke test: importing chuk_lazarus.introspection.accessor under CHUK_BACKEND=torch must not pull MLX."""
...
def test_import_accessor_with_torch_backend_does_not_load_mlx():
    code = (
        "import sys\n"
        "import chuk_lazarus.introspection.accessor  # noqa: F401\n"
