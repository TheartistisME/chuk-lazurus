"""Smoke test: importing introspection.hooks under CHUK_BACKEND=torch must not pull MLX."""
...
def test_import_hooks_with_torch_backend_does_not_load_mlx():
    code = (
        "import sys\n"
        "import chuk_lazarus.introspection.hooks  # noqa: F401\n"
